locals {
  ...
  CertificateName       = "BAMI1Wildcard"
  CertificateFileName   = "bami1elliottfieldsjr.pfx"
...
module "logging" {
  ...
  PrivateDNSZoneResourceGroupName                 = var.PrivateDNSZoneResourceGroupName
...
module "webapp" {
  ...
  CustomDomainZone                    = var.CustomDomainZone  
