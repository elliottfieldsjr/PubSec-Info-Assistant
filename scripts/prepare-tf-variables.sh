...
export TF_VAR_InfoAssistStorageAccountName=$INFOASSISTSTORAGEACCOUNTNAME
...
export TF_VAR_PrivateDNSZoneResourceGroupName=$PRIVDNSZONERESOURCEGROUPNAME
export TF_VAR_PublicDNSZoneResourceGroupName=$PUBDNSZONERESOURCEGROUPNAME
